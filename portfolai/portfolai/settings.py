"""
Django settings for portfolai project.
...
ALLOWED_HOSTS = ["app-edurancontainer-20.devedu.io", "localhost", "127.0.0.1"]
...
ROOT_URLCONF = "portfolai.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(BASE_DIR, 'home', 'templates')],# Updated this
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "portfolai.wsgi.application"
